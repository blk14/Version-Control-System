...
public final class OperationParser {
    ...
    private AbstractOperation parseVcsOperation(String newOperation,
    	...
    	/*
    	 * delete "vcs" and initialise
    	 * specific command with the name
    	 * of the command, than delete it;
    	 * create operation in operationFactory
    	 */
        operationArgs.remove(0);
        String specificCommand = operationArgs.remove(0);  // steg numele comenzii
